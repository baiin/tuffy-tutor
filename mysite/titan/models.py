...
class Course_Taken(models.Model):
	...
	prof_id = models.IntegerField(null=True, blank=True, default=None)
	course_id = models.IntegerField()
	skill_level = models.IntegerField(null=True, blank=True, default=None)
	semester_taken = models.CharField(max_length=10, null=True, blank=True, default=None)
	year_taken = models.IntegerField(null=True, blank=True, default=None)
